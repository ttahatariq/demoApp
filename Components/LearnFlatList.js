    ...
    <View style={{flex:1,}}>
      ...
      <View style={{flex:0.70, backgroundColor:'grey'}}>
        ...
        <FlatList
            ...
            renderItem={
                ({item}) => (
                <View style={{backgroundColor:'green', marginBottom:50, height:80}}>
                  ...
                  <Image 
                    ...
                    <Text style={{fontSize:10, color:'white'}}>Message:      {item.message}</Text>
